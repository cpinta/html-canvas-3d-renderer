...
export class Cube extends Object3D {
    ...
    constructor(origin: Vector3, size: number, color: Color){
        ...
        faces.push(new Face([4,7,5], color, new Vector3(-1,0,0)))
        faces.push(new Face([5,7,3], color, new Vector3(0,0,-1)))
        faces.push(new Face([5,3,1], color, new Vector3(0,0,-1)))
        faces.push(new Face([0,4,5], color, new Vector3(0,1,0)))
        faces.push(new Face([0,5,1], color, new Vector3(0,1,0)))
        faces.push(new Face([2,6,7], color, new Vector3(0,-1,0)))
        faces.push(new Face([2,7,3], color, new Vector3(0,-1,0)))
