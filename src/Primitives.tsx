...
export class Cube extends Mesh {
    ...
    constructor(origin: Vector3, size: number){
        ...
        faceObjs.push(new Face([0,2,3,1]))
        faceObjs.push(new Face([0,2,6,4]))
        faceObjs.push(new Face([4,6,7,5]))
        faceObjs.push(new Face([5,7,3,1]))
        faceObjs.push(new Face([0,4,5,1]))
        faceObjs.push(new Face([2,6,7,3]))
